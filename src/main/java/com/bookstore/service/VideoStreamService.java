...
import com.bookstore.constants.ApplicationConstants;
;
...
public class VideoStreamService {
    ...
    public ResponseEntity<byte[]> prepareContent(final String fileName, final String fileType, final String range) {
        ...
        try {
            ...
            long rangeStart = 0;
            long rangeEnd = ApplicationConstants.CHUNK_SIZE;
            ...
            if (range == null) {
                return ResponseEntity.status(HttpStatus.PARTIAL_CONTENT)
                        ...
                        .header(ApplicationConstants.CONTENT_LENGTH, String.valueOf(rangeEnd))
            ...
            if (ranges.length > 1) {
                ...
                rangeEnd = rangeStart + ApplicationConstants.CHUNK_SIZE;
            }
