...
import com.bookstore.service.VideoGalService;
...
public class VideoGalleryController {
	...
	@Autowired
	private VideoGalService imageGalleryService;
	...
	public @ResponseBody ResponseEntity<?> createProduct(@RequestParam("name") String name,
		...
		try {
			...
			VideoGallery imageGallery = new VideoGallery();
	...
	@ResponseBody
	void showImage(@PathVariable("id") Long id, HttpServletResponse response, Optional<VideoGallery> imageGallery)
	...
	String showProductDetails(@RequestParam("id") Long id, Optional<VideoGallery> imageGallery, Model model) {
		try {
			log.info("Id :: " + id);
			if (id != 0) {
				imageGallery = imageGalleryService.getImageById(id);
	...
	String show(Model map) {
		List<VideoGallery> images = imageGalleryService.getAllActiveImages();
